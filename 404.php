        ...
        <div class="error-404__content">
            ...
            <div class="error-404__links">
                ...
                <div class="error-404__links-grid">
                    ...
                    <a href="<?php echo esc_url(home_url('/available-puppies/')); ?>" class="error-404__link">
                        <span class="error-404__link-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="<?php echo esc_url(home_url('/about-us/')); ?>" class="error-404__link">
                        <span class="error-404__link-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="<?php echo esc_url(home_url('/contact-us/')); ?>" class="error-404__link">
                        <span class="error-404__link-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
